...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Users/hardiksharma/MLOPS /venv/bin',
 'BINLIBDEST': '/Users/hardiksharma/MLOPS /venv/lib/python3.11',
 ...
 'BLDSHARED': 'clang -bundle -undefined '
              ...
              ''
              ''
              '-Wl,-rpath,/Users/hardiksharma/MLOPS /venv/lib '
              '-L/Users/hardiksharma/MLOPS /venv/lib '
              ''
              ''
              ''
              ''
 ...
 'CFLAGS': '-DNDEBUG -fwrapv -O2 -Wall '
           ...
           '-fPIC   -O2  '
           '-isystem '
           '/Users/hardiksharma/MLOPS /venv/include '
           ''
           ''
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Users/hardiksharma/MLOPS /venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      ''
                      ''
 ...
 'CONFIG_ARGS': "'--prefix=/Users/hardiksharma/MLOPS /venv'"
                "'--build=arm64-apple-darwin20.0.0'"
                "'--host=arm64-apple-darwin20.0.0''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/Users/hardiksharma/MLOPS /venv/share/zoneinfo:/Users/hardiksharma/MLOPS /venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-ffi'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/Users/hardiksharma/MLOPS /venv/include'"
                "'--with-tcltk-libs=-L/Users/hardiksharma/MLOPS /venv/lib "
                ...
                "'PKG_CONFIG_PATH=/Users/hardiksharma/MLOPS /venv/lib/pkgconfig'"
                ...
                '-mmacosx-version-min=11.1 '
                "-I/Users/hardiksharma/MLOPS /venv/include'",
 'CONFINCLUDEDIR': '/Users/hardiksharma/MLOPS /venv/include',
 'CONFINCLUDEPY': '/Users/hardiksharma/MLOPS /venv/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/Users/hardiksharma/MLOPS /venv '
             '/Users/hardiksharma/MLOPS /venv/lib '
             '/Users/hardiksharma/MLOPS /venv/lib/python3.11 '
             '/Users/hardiksharma/MLOPS /venv/lib/python3.11/lib-dynload',
 'DESTLIB': '/Users/hardiksharma/MLOPS /venv/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/Users/hardiksharma/MLOPS /venv/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/hardiksharma/MLOPS /venv/include '
                   '/Users/hardiksharma/MLOPS /venv/include '
                   '/Users/hardiksharma/MLOPS /venv/include/python3.11 '
                   '/Users/hardiksharma/MLOPS /venv/include/python3.11',
 'INCLUDEDIR': '/Users/hardiksharma/MLOPS /venv/include',
 'INCLUDEPY': '/Users/hardiksharma/MLOPS /venv/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/Users/hardiksharma/MLOPS /venv/lib/python3.11',
 'LIBDIR': '/Users/hardiksharma/MLOPS /venv/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/Users/hardiksharma/MLOPS /venv/include',
 'LIBM': '',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/hardiksharma/MLOPS /venv/lib/pkgconfig',
 'LIBPL': '/Users/hardiksharma/MLOPS /venv/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/hardiksharma/MLOPS /venv/lib/python3.11',
 ...
 'MANDIR': '/Users/hardiksharma/MLOPS /venv/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/Users/hardiksharma/MLOPS /venv/include',
 'MODULE_BINASCII_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/Users/hardiksharma/MLOPS /venv/include',
 'MODULE_ZLIB_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/Users/hardiksharma/MLOPS /venv/include',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/Users/hardiksharma/MLOPS /venv/include',
 'MODULE__LZMA_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/Users/hardiksharma/MLOPS /venv/include '
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/Users/hardiksharma/MLOPS /venv/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/Users/hardiksharma/MLOPS /venv/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib '
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/hardiksharma/MLOPS /venv/include',
 'OPENSSL_LDFLAGS': '-L/Users/hardiksharma/MLOPS /venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Users/hardiksharma/MLOPS /venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Users/hardiksharma/MLOPS /venv/share/zoneinfo:/Users/hardiksharma/MLOPS /venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'WASM_ASSETS_DIR': './Users/hardiksharma/MLOPS /venv',
 'WASM_STDLIB': './Users/hardiksharma/MLOPS /venv/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/Users/hardiksharma/MLOPS /venv/share',
 'exec_prefix': '/Users/hardiksharma/MLOPS /venv',
 'prefix': '/Users/hardiksharma/MLOPS /venv',
